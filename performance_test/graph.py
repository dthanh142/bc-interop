...
def construct_graph():
	...
	# Enter raw data
	bitcoin = np.array([6.4e-5, 3.01e-5, 2.36e-5, 3.0e-5,
						7.0e-5, 4.5e-5, 3.8e-5, 4.2e-5, 2.62e-5, 3.6e-5])
	ethereum = np.array([4.5e-5, 1.97e-5, 1.6e-5, 1.97e-5, 4.0e-5,
					2.4e-5, 1.9e-5, 2.41e-5, 1.85e-5, 3.3e-5])
	stellar = np.array([3.3e-5, 1.2e-5, 0.9e-5, 1.2e-5, 1.3e-5,
